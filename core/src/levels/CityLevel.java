...
public class CityLevel extends GameLevel {
    ...
    public void update(float dt) {
        ...
        if (disasterTimer >= disasterThreshold) {
            ...
            disasterThreshold = Assets.rand.nextFloat() * 15f + 4f;
...
//        Gdx.app.log("DISASTER", "got off safe this time...");
    ...
    private void generatePowerGrid() {
        int[][] layout = new int[][] {
                ...
                { 20, 20, 20, 20, 20, 20, 20, 17, 13, 13, 20, 13, 18, 20, 17, 18, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20 },
                ...
                { 20, 20, 20, 20, 20, 19, 13, 13, 20, 13, 13, 18, 20, 20, 20, 14, 20, 14, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20 },
